...
const PerformanceReviewForm = ({}) => {
  ...
  return (
    <form onSubmit={onSubmit} className="mt-5 max-w-4xl mx-auto">
      ...
      <div className="mb-8 bg-white shadow-md pb-2">
          ...
          <div className="mx-6 mt-[12px]">
            ...
            <div className="flex items-start gap-2 mb-1">
              ...
              <select
                ...
                className="border border-blackLight rounded "
                required
              >
            ...
            {formData.goals.map((goal, index) => (
              <div key={index} className="rounded-lg">
                ...
                {goal.quarterlyUpdates.map((update, subIndex) => (
                  <div
                    key={subIndex}
                    className="flex items-start border-[2px] border-black mb-2"
                  >
                ...
                <div className="flex items-start gap-2 mb-2">
                  <div className="w-1/2  border-[2px] border-blackLight">
                    <label className="block border-b-[2px] border-black px-1 text-[14px] font-medium">
                      Employee Feedback
                    </label>
                    <textarea
                  ...
                  <select
                    ...
                    onChange={(e) => handleInputChange(e, "goals", index)}
                    className="w-1/2 p-2 py-3 border-[2px] border-black rounded"
                  >
                    <option value="" className='text-[14px]'>Select Self-Rating</option>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <select
                    ...
                    disabled
                  >
                    <option value="" className='text-[14px]'>Select Manager Rating</option>
                    <option value="Significantly Exceeds Requirements (SER)">
                      Significantly Exceeds Requirements (SER)
                    </option>
                    <option value="Exceeds Requirements (ER)">
        ...
        <button
          onClick={handlePrint}
          className="ml-6 py-2 px-6 bg-red-500 text-white font-semibold rounded hover:bg-red-600 transition duration-300"
        >
          Print
        </button>
      </div>
      ...
      {/* goals section  */}
      <div className="pb-2 mb-4 bg-white shadow-md">
